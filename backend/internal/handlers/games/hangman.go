...
var hangmanWordList = []string{
	...
	"SEAHORSE", "JELLYFISH", "HONEYBEE", "MACKEREL", "FLAMINGO", "PUFFIN",
	"SALAMANDER", "MANDRILL", "TAPIR", "IGUANA",
	// Geography & Nature
	"VOLCANO", "CACTUS", "COMPASS", "GLACIER",
	...
	"POLO", "CRICKET", "SOFTBALL", "BIATHLON",
	// Occupations & People
	...
	"MOMENTUM", "MONUMENT", "MOREOVER", "MULTIPLE", "NEGATIVE",
	...
	"SYMBOLIC", "TERMINAL", "THOUSAND", "TIMELINE", "TOGETHER",
