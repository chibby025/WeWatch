      ...
      <div className={isSearching ? "grid grid-cols-2 gap-2 items-start" : "md:grid md:grid-cols-2 md:gap-4 md:items-start"}>
        {posts.map((post, index) => {
          ...
          <React.Fragment key={`post-${post.id}`}>
            {/* Post Card */}
            <div
              className="flex flex-col bg-white dark:bg-gray-950 cursor-pointer rounded-xl border border-white/25 shadow-lg hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-200 mb-3 sm:mb-4 md:mb-0 overflow-hidden"
