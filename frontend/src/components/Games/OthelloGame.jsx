...
export default function OthelloGame({ gameState, players, currentUserId, onMove, onClose, onEndGame }) {
      ...
      <div className="relative bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        {winner && (
          <div className={`p-5 border-b border-gray-700 text-center ${
            ...
            <div className="text-sm mt-1 text-gray-300">⚫ {counts.black} — {counts.white} ⚪</div>
          </div>
        )}
