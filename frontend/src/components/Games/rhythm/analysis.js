...
//
// Vendored from github.com/petehottelet/claudetarhero (MIT) unchanged — a
// real, from-scratch DSP pipeline (radix-2 FFT, 5-band spectral flux, onset
// peak-picking, autocorrelation-based BPM estimation) that solves the hardest
// part of this feature: auto-generating a playable note chart from arbitrary
// user-supplied audio, with no external tempo/beat-detection API needed.
